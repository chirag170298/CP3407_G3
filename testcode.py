...
try:
    ...
    if connection.is_connected():
        ...
        # Insert values
        insert_queries = [
            "INSERT INTO users (id, username, password) VALUES (8888, 'TestUser1', 'password1')",
            "INSERT INTO Person (PersonID, FirstName, LastName, StoreID, RoleID, users_id) VALUES (8888, 'John', 'Doe', 1, 1, 8888)",
            "INSERT INTO Sales (SaleID, SaleDate, PersonID) VALUES (1000, '2024-08-01', 8888)",
            ...
            "INSERT INTO PERFORMANCE (PersonID, FEEDBACK, TASKS_COMPLETED, ATTENDANCE, EFFICIENCY, TRAINING_COMPLETED) VALUES (8888, 'Good', 5, 100, 90, 2)",
        ...
        delete_queries = [
            ...
            "DELETE FROM PERFORMANCE WHERE PersonID = 8888",
